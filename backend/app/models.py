...
class User(Base):
    ...
    health_goal: Mapped[str] = mapped_column(String(32), default="maintenance")
    target_calories: Mapped[int] = mapped_column(Integer, default=0)
    macro_preference: Mapped[str] = mapped_column(String(32), default="balanced")
    favorite_meal_ids: Mapped[str] = mapped_column(Text, default="[]")
    excluded_ingredient_ids: Mapped[str] = mapped_column(Text, default="[]")
